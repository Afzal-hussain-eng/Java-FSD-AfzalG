...
public class RegestrationForm {
	...
	public void invokeBrowser() {
		 WebDriver driver = new ChromeDriver();
		  ...
		  driver.findElement(By.xpath("//*[@id='email_create']")).sendKeys("alfaaz135@gmail.com");
		  ...
		  driver.findElement(By.xpath("//*[@id='customer_firstname']")).sendKeys("Afzal");
		  driver.findElement(By.xpath("//*[@id='customer_lastname']")).sendKeys("Hussain");
		  driver.findElement(By.xpath("//*[@id='passwd']")).sendKeys("Password@143");
		  ...
		  sMonth.selectByVisibleText("September ");
		  ...
		  driver.findElement(By.xpath("//*[@id='firstname']")).sendKeys("Afzal");
		  driver.findElement(By.xpath("//*[@id='lastname']")).sendKeys("hussain");
		  ...
		  driver.findElement(By.xpath("//*[@id='alias']")).sendKeys("Alfaaz");
